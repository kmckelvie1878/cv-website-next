        ...
        <Layout title="3D Self Portrait">
            <Container maxW="container.lg">
                ...
                <SimpleGrid columns={[1,1,2]} gap={6}>
                    <WorkImage src="/images/3d-avatar-3.jpg" alt="Creating a 3D self portrait in Blender" />
                    <WorkImage src="/images/3d-avatar-2.jpg" alt="3D head initial render" />
                </SimpleGrid>
                <WorkImage src="/images/3d-me-showpiece.jpg" alt="3D Head-ception" />
            </Container>
        </Layout>
    )
}
